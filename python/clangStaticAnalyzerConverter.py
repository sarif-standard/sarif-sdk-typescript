...
def main(args):
    ...
    for plistFile in args.plist_files:
...
if __name__ == "__main__":
    ...
    parser.add_argument("plist_files", nargs='+', type=str,
                    help="list of plist files")
    parser.add_argument("--sarif_output", type=str,
                    help="output")
    parser.add_argument("--project_dir", type=str,
                    help="project directory")
    parser.add_argument("--encode_edges", action='store_true',
